...
export default {
    ...
    data() {
        return {
            ...
            editableFields: [
                { key: 'firstName', label: 'Имя', type: 'text', editable: true },
                { key: 'lastName', label: 'Фамилия', type: 'text', editable: true },
                { key: 'middleName', label: 'Отчество', type: 'text', editable: true },
                { key: 'birthDate', label: 'Дата рождения', type: 'date', editable: true },
